              ...
              >
                ...
                <div className="flex flex-col items-center gap-2">
                  <div className="flex items-center gap-2">
                    <a
                      href={`https://twitter.com/intent/tweet?text=${encodeURIComponent(`Just claimed my @0xmaiat Passport 🛡️\n\n${result.ensFullName} — my verifiable identity is live.\n\nClaim yours and earn 🪲 Scarab →`)}&url=${encodeURIComponent(`https://passport.maiat.io/share/${result.ensName}`)}`}
                      target="_blank"
